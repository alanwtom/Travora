...
export default function ExploreVideoFeedScreen() {
  const { startIndex, returnTo } = useLocalSearchParams<{ startIndex?: string; returnTo?: string }>();
  ...
  const { videos, isLoading, isRefreshing, loadMore, refresh, hasMore } = useFeedVideos();
